...
It is intentionally compact and exists to demonstrate:
...
- Serve as a reference implementation for small-scale UI automation that can be adapted into larger team frameworks
